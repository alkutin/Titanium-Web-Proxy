    ...
    partial class ProxyServer
    {
            ...
            CustomBinaryReader clientStreamReader, StreamWriter clientStreamWriter, string secureTunnelHostName)
        {
            ...
            try
            {
                ...
                args.ProxyRequest = new RequestEncoder(new RoutesFilter(new EncodedRemoteTransfer(), new EncodedBluetoothTransfer(),
                    new ResponseEncoder()), httpRemoteUri, httpMethod, version);//
